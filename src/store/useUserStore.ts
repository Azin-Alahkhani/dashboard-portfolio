...
export const useUserStore = create<UserStore>((set, get) => ({
  ...
  linkedAccounts: {
    ...
    Reddit: { linked: true, username: "janereddit" },
    GitHub: { linked: true, username: "janedoe_github" },
    Medium: { linked: true, username: "janedoe_medium" },
    WhatsApp: { linked: false },
    Telegram: { linked: true, username: "janedoe_telegram" },
    Discord: { linked: true, username: "janedoe_discord" },
    Tumblr: { linked: false },
